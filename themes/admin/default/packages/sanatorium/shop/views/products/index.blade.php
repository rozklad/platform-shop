...
@section('title')
@parent
{{ trans('sanatorium/shop::products/common.title') }}
@stop
...
{{ Asset::queue('index', 'sanatorium/shop::products/js/index.js', 'platform') }}
...
<section class="panel panel-default panel-grid">
		...
		<nav class="navbar navbar-default navbar-actions">
			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<span class="navbar-brand">{{{ trans('sanatorium/shop::products/common.title') }}}</span>
				...
				<div class="collapse navbar-collapse" id="actions">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="primary">
							<a href="{{ route('admin.sanatorium.shop.products.create') }}" data-toggle="tooltip" data-original-title="{{{ trans('action.create') }}}">
					...
					{{-- Grid: Filters --}}
					<form class="navbar-form navbar-right" method="post" accept-charset="utf-8" data-search data-grid="product" role="form">
						...
						<div class="input-group">
							...
							<span class="input-group-btn">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li>
										<a data-grid="product" data-filter="enabled:1" data-label="enabled::{{{ trans('common.all_enabled') }}}" data-reset>
											<i class="fa fa-eye"></i> {{{ trans('common.show_enabled') }}}
										</a>
									</li>

									<li>
										<a data-toggle="tooltip" data-placement="top" data-original-title="" data-grid="product" data-filter="enabled:0" data-label="enabled::{{{ trans('common.all_disabled') }}}" data-reset>
							...
							<span class="input-group-btn">
								...
								<button class="btn btn-default" data-grid="product" data-reset>
	...
	<div class="panel-body">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="data-grid-applied-filters">
			...
			<div id="data-grid_applied" class="btn-group" data-grid="product"></div>
	...
	<div class="table-responsive">
		...
		<table id="data-grid" class="table table-hover" data-source="{{ route('admin.sanatorium.shop.products.grid') }}" data-grid="product">
			<thead>
				<tr>
					<th><input data-grid-checkbox="all" type="checkbox"></th>
					<th class="sortable" data-sort="id">{{{ trans('sanatorium/shop::products/model.general.id') }}}</th>
					<th></th>
					<th></th>
					<th class="sortable" data-sort="slug">{{{ trans('sanatorium/shop::products/model.general.slug') }}}</th>
					<th class="sortable" data-sort="code">{{{ trans('sanatorium/shop::products/model.general.code') }}}</th>
					<th class="sortable" data-sort="ean">{{{ trans('sanatorium/shop::products/model.general.ean') }}}</th>
					<th class="sortable" data-sort="weight">{{{ trans('sanatorium/shop::products/model.general.weight') }}}</th>
					<th class="sortable" data-sort="stock">{{{ trans('sanatorium/shop::products/model.general.stock') }}}</th>
					<th class="sortable" data-sort="created_at">{{{ trans('sanatorium/shop::products/model.general.created_at') }}}</th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
	...
	<footer class="panel-footer clearfix">
		...
		{{-- Grid: Pagination --}}
		<div id="data-grid_pagination" data-grid="product"></div>

	</footer>

	{{-- Grid: templates --}}
	@include('sanatorium/shop::products/grid/index/results')
	@include('sanatorium/shop::products/grid/index/pagination')
	@include('sanatorium/shop::products/grid/index/filters')
	@include('sanatorium/shop::products/grid/index/no_results')

</section>

@if (config('platform.app.help'))
	@include('sanatorium/shop::products/help')
@endif
